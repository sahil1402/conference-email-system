...
> **The figures in this section and the table below are the state as of the manual decisions.** A later targeted follow-up changed `reviewer_assignment` only — current totals are **113 clusters / 717 noise / 80.4% coverage**, and that intent is now **15 clusters / 168 noise / 71.9%**. See *Addendum — E012 targeted UMAP decomposition* at the end of this section.
