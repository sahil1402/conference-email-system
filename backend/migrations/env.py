...
from app.db.database import ASYNC_DATABASE_URL, Base
...
# Inject the runtime database URL (async driver) from app settings, so the
# migration connection matches the application's connection.
